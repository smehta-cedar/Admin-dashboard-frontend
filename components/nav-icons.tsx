/*
 * Sidebar icons. Hand-rolled inline SVGs (no icon package) on a shared 24x24
 * grid so every glyph has the same weight and optical size. Sized by the
 * caller through `className`; they inherit the link's text color.
 */
...
const PATHS: Record<NavIconName, string> = {
  ...
  // A storefront: the shop itself, as opposed to the carriers' office block.
  agency:
